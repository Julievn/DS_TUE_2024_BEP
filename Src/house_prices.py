...
def processHousePrices(path_to_house_prices_csv_file, path_to_shape_file):
    ...
    for year_idx in range(1):    
        ...
        municipalities_polygons_with_house_prices = getMunicipalitiesPolygonsWithData(path_to_shape_file, year, house_prices_per_year, data_name, output_housing_price_folder, False)
